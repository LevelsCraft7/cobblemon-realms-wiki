...
Want to enjoy **Cobblemon Realms** with friends or build your own community server? Here's how to get started!

---

## 🧑‍🤝‍🧑 Join an Existing Server

You can quickly join featured or partner servers **directly from the modpack’s main menu**.  
...
- ✅ Use a **whitelist** to manage access (`whitelist.json`)
