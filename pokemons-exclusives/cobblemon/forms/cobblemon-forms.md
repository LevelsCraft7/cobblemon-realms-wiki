...
{% hint style="info" %}
<p align="center">
Cette page présente les différentes catégories d'apparences spéciales disponibles.
</p>
{% endhint %}

<p align="center">
Les <strong>apparences spéciales</strong> regroupent toutes les variantes <strong>visuelles</strong> disponibles dans le modpack. Contrairement aux formes officielles de Pokémon, ces variantes sont principalement esthétique et n'affectent <strong>aucunement</strong> les statistiques ni les capacités des Pokémon concernés.
</p>
...
{% hint style="info" %}
Certaines apparences nécessitent l'activation du pack de ressources intégré correspondant pour être visibles.
{% endhint %}
