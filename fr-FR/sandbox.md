...
1. Téléchargez et installez l'application CurseForge.
2. Recherchez **Cobblemon Realms**.
3. Cliquez sur **Installer**.
4. Attendez la fin du téléchargement.
5. Lancez le jeu.

{% hint style="success" %}
CurseForge est le launcher recommandé pour garantir une installation complète et éviter les problèmes de configuration.
{% endhint %}
