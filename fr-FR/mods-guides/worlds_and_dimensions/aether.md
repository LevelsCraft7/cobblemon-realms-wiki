...
{% hint style="info" %}
<p align="center"><strong>The Aether</strong> est une dimension céleste composée d'îles flottantes, de donjons, de boss et de nombreuses récompenses uniques. Sur Cobblemon Realms, elle accueille également de nombreux Pokémon rares, légendaires et late-game.</p>
{% endhint %}
...
{% hint style="info" %}
<p align="center">Les informations Cobblemon Realms présentées ci-dessus sont basées sur la configuration actuelle des spawns personnalisés de la dimension Aether dans le modpack.</p>
{% endhint %}
