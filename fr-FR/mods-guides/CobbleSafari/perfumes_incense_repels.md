# 🌸 Parfums, Encens et Repousses

{% hint style="info" %}
<p align="center">Les <strong>Encens</strong> et <strong>Parfums</strong> vous permettent d’influencer les rencontres de Pokémon sauvages afin de favoriser certains types ou conditions rares. Ces objets augmentent la probabilité d’apparition de Pokémon possédant des caractéristiques spécifiques.</p>
{% endhint %}

{% hint style="success" %}
<p align="center">Contrairement aux potions classiques de Minecraft, utiliser plusieurs parfums ou encens successivement <strong>prolonge la durée totale</strong> au lieu de réinitialiser l’effet.</p>
{% endhint %}
...
{% hint style="info" %}
<p align="center">Les Pokémon déjà présents ne peuvent pas être reroll par l’encens.</p>
{% endhint %}
...
{% hint style="warning" %}
<p align="center">Les bonus shiny ne se cumulent pas avec d’autres systèmes de boost issus d’autres mods.</p>
{% endhint %}
...
{% hint style="info" %}
<p align="center">Le PokéNav n’affiche pas l’influence des parfums sur les taux d’apparition.</p>
{% endhint %}
...
{% hint style="danger" %}
<p align="center">Utiliser Repousse + Encens + Parfum en même temps est fortement déconseillé.<br>Le Repousse bloque les apparitions, annulant totalement les effets des boosts.</p>
{% endhint %}
...
<p align="center">Certaines valeurs présentes dans le fichier de configuration ne sont pas encore actives en jeu.<br>Elles seront utilisées dans de futures mises à jour.</p>
{% endhint %}

{% hint style="info" %}
## Plus d'informations

<p align="center">Vous trouverez une description complète du fichier de configuration sur la page officielle du mod : <a href="https://cobblesafari.maxigregrze.fr/en/addons/config_encounter_boost_config">Encounter_boost_config</a></p>
{% endhint %}
