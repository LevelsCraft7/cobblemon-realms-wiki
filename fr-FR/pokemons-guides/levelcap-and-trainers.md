...
{% hint style="warning" %}
<p align="center">
<strong>🚧 Cette page est en cours de révision</strong>
</p>

<p align="center">
Certaines informations peuvent être incorrectes ou ne plus correspondre à la version actuelle du modpack.
Merci de vous référer aux autres guides du wiki en attendant sa mise à jour.
</p>
{% endhint %}

{% hint style="info" %}
<p align="center">
La progression des dresseurs dans Cobblemon Realms repose sur un système de <strong>Cartes de Dresseur</strong>, de <strong>Dresseurs Clés</strong> et de <strong>Séries de Dresseurs</strong>. Ces différents éléments permettent de structurer l'aventure et d'accompagner le joueur tout au long de sa progression.
</p>
{% endhint %}
