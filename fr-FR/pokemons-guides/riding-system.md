...
{% hint style="info" %}
<p align="center">Depuis la version <strong>1.7</strong>, Cobblemon Realms utilise désormais le système de montures officiel.</p>
{% endhint %}
...
{% hint style="success" %}
Il est également possible de modifier certaines de ces caractéristiques grâce aux [Aprijuices](../cobblemon-craft/aprijuice-guide.md)
{% endhint %}
...
Ci-dessous se trouve la liste complète des Pokémon actuellement montables avec le système officiel de Cobblemon. Les statistiques sont indiquées par type de monture et proviennent directement du tableau officiel des montures Cobblemon.
